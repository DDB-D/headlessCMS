...
import { Flowmap } from '../../node_modules/ogl/src/Extras.js';
			...
			`;
    {
      ...
      img.src = "../../assets/videos/stage_bg-vid/stage_bg-vid.png";
...
const imgSize = [1280, 720];
    ...
    `;
  {
    ...
    img.onload = () => (texture.image = img);
    img.crossOrigin = "Anonymous";
    img.src = "../videos/stage_bg-vid/stage_bg-vid.png";
...
/*
import {
    Renderer, Camera, Mesh, Box, NormalProgram
} from 'https://cdn.jsdelivr.net/npm/ogl@0.0.25/dist/ogl.mjs';
*/
/*
import {
  Renderer, Camera, Transform, Program, Mesh
} from '../../node_modules/ogl/dist/ogl.mjs';
import { Box, NormalProgram } from '../../node_modules/ogl/src/Extras.js';
*/
