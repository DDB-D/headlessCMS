	...
	`;
{
  ...
  // get targetDiv
  var targetDiv = document.getElementById("content_projects_index_bg-img");

  //get dimensions of targetDiv
  var targetDiv_width = $("#content_projects_index_bg-img").width();
  var targetDiv_height = $("#content_projects_index_bg-img").height();
  ...
  img.src = "../../assets/graphics/blog-overview_stage_bg-canvas.png";
